...
internal val logger: SkipLogger = SkipLogger(subsystem = "junio.rbank", category = "JunioRBank")
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        JunioRBankAppDelegate.shared.onStart()
    }

    override fun onResume() {
        super.onResume()
        JunioRBankAppDelegate.shared.onResume()
    }

    override fun onPause() {
        super.onPause()
        JunioRBankAppDelegate.shared.onPause()
    }

    override fun onStop() {
        super.onStop()
        JunioRBankAppDelegate.shared.onStop()
    }

    override fun onDestroy() {
        super.onDestroy()
        JunioRBankAppDelegate.shared.onDestroy()
    }

    override fun onLowMemory() {
        super.onLowMemory()
        JunioRBankAppDelegate.shared.onLowMemory()
    }
